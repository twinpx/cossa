...
<div id="vk_like_2" class="vk_like"></div>
<script type="text/javascript">
VK.Widgets.Like("vk_like_2", {type: "mini",pageUrl:"<?="http://".$_SERVER["SERVER_NAME"].$PAGE_URL?>"});
_ga.trackVkontakte();
</script>

<a href="http://twitter.com/share" class="twitter-share-button" data-url="<?='http://'.$_SERVER["SERVER_NAME"].$PAGE_URL?>" data-count="horizontal" data-lang="ru" id="twitter_button2">Твитнуть</a>
	<script type="text/javascript">
		var h1Text = $.trim($("h1").text());
		$("#twitter_button2").attr({"data-text": h1Text});
	</script>
